...
emails=("john.smith@example.com" "sarah.johnson@example.com" "mike.davis@example.com" "emily.wilson@example.com" "david.brown@example.com" "lisa.anderson@example.com" "james.taylor@example.com" "maria.garcia@example.com" "robert.martinez@example.com" "jennifer.lee@example.com" "william.rodriguez@example.com" "amanda.white@example.com" "christopher.thompson@example.com" "jessica.moore@example.com" "daniel.jackson@example.com" "ashley.martin@example.com" "matthew.lee@example.com" "nicole.clark@example.com" "joshua.lewis@example.com" "stephanie.hall@example.com")
...
echo "✅ Created 20 test inventory entries!"
